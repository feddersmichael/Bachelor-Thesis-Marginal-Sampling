...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "conversion_reaction_0.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'conversion_reaction_0._conversion_reaction_0',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'conversion_reaction_0',
...
# Install
setup(
    name='conversion_reaction_0',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model conversion_reaction_0',
