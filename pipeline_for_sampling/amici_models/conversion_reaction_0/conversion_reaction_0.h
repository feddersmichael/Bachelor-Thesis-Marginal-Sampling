...
extern void Jy_conversion_reaction_0(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_conversion_reaction_0(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_conversion_reaction_0(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals, int index);
extern void dwdp_conversion_reaction_0(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp);
extern void dwdp_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);
extern void dwdx_conversion_reaction_0(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);
extern void dwdw_conversion_reaction_0(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdw_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);
extern void dxdotdw_conversion_reaction_0(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);
extern void dxdotdp_explicit_conversion_reaction_0(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_explicit_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);
extern void dxdotdx_explicit_conversion_reaction_0(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdx_explicit_colptrs_conversion_reaction_0(SUNMatrixWrapper &colptrs);
extern void dxdotdx_explicit_rowvals_conversion_reaction_0(SUNMatrixWrapper &rowvals);

extern void dydx_conversion_reaction_0(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_conversion_reaction_0(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_conversion_reaction_0(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_conversion_reaction_0(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_conversion_reaction_0(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_conversion_reaction_0(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_conversion_reaction_0(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_conversion_reaction_0(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_conversion_reaction_0(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_conversion_reaction_0(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_conversion_reaction_0(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_conversion_reaction_0(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_conversion_reaction_0(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_conversion_reaction_0 : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_conversion_reaction_0()
        : amici::Model_ODE(
              2,                                // nx_rdata
              2,                            // nxtrue_rdata
              2,                               // nx_solver
              ...
              std::vector<realtype>{0.0, 0.0, 0.0, 0.0},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_conversion_reaction_0(*this);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_conversion_reaction_0(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_conversion_reaction_0(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_conversion_reaction_0(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_conversion_reaction_0( dJydy,  iy,  p,  k,  y,  sigmay,  my);
    }

    virtual void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {
        dJydy_colptrs_conversion_reaction_0(colptrs, index);
    }

    virtual void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {
        dJydy_rowvals_conversion_reaction_0(rowvals, index);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp) override {
        dwdp_conversion_reaction_0( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp);
    }

    virtual void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_conversion_reaction_0( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }

    virtual void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdw_conversion_reaction_0( dwdw,  t,  x,  p,  k,  h,  w,  tcl);
    }

    virtual void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdw_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdw_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_conversion_reaction_0( dxdotdw,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdp_explicit_conversion_reaction_0( dxdotdp_explicit,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdp_explicit_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdp_explicit_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdx_explicit_conversion_reaction_0( dxdotdx_explicit,  t,  x,  p,  k,  h,  w);
    }

    virtual void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdx_explicit_colptrs_conversion_reaction_0(colptrs);
    }

    virtual void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdx_explicit_rowvals_conversion_reaction_0(rowvals);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
        ...
        dydx_conversion_reaction_0(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_conversion_reaction_0(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsigmay(realtype *sigmay, const realtype t, const realtype *p,
        ...
        sigmay_conversion_reaction_0(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t, const realtype *x0,
                      const realtype *p, const realtype *k,
                      const int ip) override {
        sx0_conversion_reaction_0(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_conversion_reaction_0(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_conversion_reaction_0( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx0(realtype *x0, const realtype t, const realtype *p,
                     const realtype *k) override {
        x0_conversion_reaction_0(x0, t, p, k);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_conversion_reaction_0(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_conversion_reaction_0(xdot, t, x, p, k, h, w);
    }
    ...
    virtual void fy(realtype *y, const realtype t, const realtype *x,
                    const realtype *p, const realtype *k, const realtype *h,
                    const realtype *w) override {
        y_conversion_reaction_0(y, t, x, p, k, h, w);
    }
    ...
    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_conversion_reaction_0( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_conversion_reaction_0( total_cl,  x_rdata);
    }


    std::string getName() const override {
        return "conversion_reaction_0";
    }
