...
/*-----------------------------------------------
              @(target):= _conversion_reaction_0.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__conversion_reaction_0

#else
#  define SWIG_init    init_conversion_reaction_0

#endif
#define SWIG_name    "_conversion_reaction_0"
